...
class RedRectangleDetector:
    ...
    """
    def __init__(self, min_contour_area=1000,
                 l_range: tuple = (0, 255),
    ...
    def _get_red_mask(self, image: np.ndarray) -> np.ndarray:
        ...
        red_mask = cv2.inRange(img_lab_eq,
                               self.lower_lab_red,
                               self.upper_lab_red)
        ...
        red_mask_opened = cv2.morphologyEx(red_mask,
                                           cv2.MORPH_OPEN,
                                           kernel,
                                           iterations=2)
    ...
    def draw_centroids(self, image: np.ndarray,
                       centroids: list[tuple]) -> np.ndarray:
        """
    ...
    def find_missing_points(self,
                            ...
                            image: np.ndarray) -> list[tuple[float, float]]:
        ...
        if known_points_len == 3:
            ...
            if "top" in known_points[0] and "top" in known_points[1]:
                ...
                points["bottom_left"] = (points["top_left"][0],
                                         int(points["top_left"][1] +
                                             (center[1] -
                                              points["top_left"][1]) * 2))

                points["bottom_right"] = (points["top_right"][0],
                                          int(points["top_right"][1] +
                                              (center[1] -
                                               points["top_right"][1]) * 2))

            elif "bottom" in known_points[0] and "bottom" in known_points[1]:
                points["top_left"] = (points["bottom_left"][0],
                                      int(points["bottom_left"][1] -
                                          (points["bottom_left"][1] -
                                           center[1]) * 2))

                points["top_right"] = (points["bottom_right"][0],
                                       int(points["bottom_right"][1] -
                                           (points["bottom_right"][1] -
                                            center[1]) * 2))

            elif "left" in known_points[0] and "left" in known_points[1]:
                points["top_right"] = (int(points["top_left"][0] +
                                           (center[0] -
                                            points["top_left"][0]) * 2),
                                       points["top_left"][1])

                points["bottom_right"] = (int(points["bottom_left"][0] +
                                              (center[0] -
                                               points["bottom_left"][0]) * 2),
                                          points["bottom_left"][1])

            elif "right" in known_points[0] and "right" in known_points[1]:
                points["top_left"] = (int(points["top_right"][0] -
                                          (points["top_right"][0] -
                                           center[0]) * 2),
                                      points["top_right"][1])

                points["bottom_left"] = (int(points["bottom_right"][0] -
    ...
    def painting_black_outside_rectangle(self,
                                         image: np.ndarray,
        ...
        points = [ordered_points["top_left"],
